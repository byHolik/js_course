...
function isBudgetEnough(data) {
	...
	totalCost = totalVolume * data.moneyPer1m3;

	if (data.budget - totalCost < 0) {
		return `Расходы составляют ${totalCost}$, бюджета ${data.budget}$ недостаточно`;
	} else {
		return `Расходы составляют ${totalCost}$, бюджета ${data.budget}$ достаточно`;
	}
}
